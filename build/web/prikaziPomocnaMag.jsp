...
<html>
    <head>
        ...
        <script language="javascript">
            ...
            var f=document.form;
            f.method="post";
            f.action='prikaziProizvodMag.jsp?ID='+ID;
            f.submit();
            }
          </script> 
    </head>
     <body bgcolor="#1E2F41">
       <div class="naslov">
        ...
        <ul class="ul">
          ...
          <div class="meni"> 
            <p><a href="pomocnaopremamag.jsp">Nazad</a></p>
            <p></p>
          </div>
            </div>
...
<%
    ...
    try {
        ...
        String query = "select * from pomocnaoprema where id='"+ID+"'";
...
<tr>
    ...
    <%
        ...
        String query1 = "select * from proivodjac where ID"+ID+"'";
        st = con.createStatement();
        ResultSet rs1 = st.executeQuery(query);
        %>
           <td><input type="button" name="prikazi" value="Prikazi" style="background-color:#ff0000;font-weight:bold;color:#ffffff;" onclick="prikaz(<%=rs.getString(1)%>);" ></td>
     <%
